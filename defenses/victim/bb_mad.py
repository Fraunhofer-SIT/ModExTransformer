""" MIT License
    ...
    This file was copied from https://github.com/tribhuvanesh/prediction-poisoning/blob/master/defenses/victim/bb_mad.py 
...
class MAD(Blackbox):
    def __init__(self, epsilon=None, optim='linesearch', model_adv_proxy=None, max_grad_layer=None, ydist='l1',
        ...
        if model_adv_proxy is not None:
            self.model_adv_proxy = model_adv_proxy
